...
using Spring.Net.Example.Dao.Config;
...
namespace Spring.Net.Example.Dao.Database
{
    public abstract class DbHelper
    {
        ...
        {
            return ExecuteNonQuery(DBConfig.connString, cmdType, cmdText, commandParameters);
        }
        ...
        {
            return ExecuteReader(DBConfig.connString, cmdType, cmdText, commandParameters);
        }
        ...
        {
            return ExecuteScalar(DBConfig.connString, cmdType, cmdText, commandParameters);
        }
        ...
        {
            return ExecuteTable(DBConfig.connString, cmdType, cmdText, commandParameters);
        }
        ...
        {
            return ExecutePage(DBConfig.connString, SqlAllFields, SqlTablesAndWhere, IndexField, OrderFields, PageIndex, PageSize, out  RecordCount, out  PageCount, commandParameters);
        }
